...
const DB_URL =  process.env.DATABASE_URL || 'mongodb+srv://sandaru:sandu123@cluster0.piqcnbr.mongodb.net/';
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~c6bf6HPaW89cf5c6715f55b9cf5e0c6eab51', //your ssid to run bot
    HEROKU: {
